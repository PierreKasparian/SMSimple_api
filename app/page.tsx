...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                SMS Integration Made <span className="text-primary">Simple</span>
              </h1>
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Powerful SMS API for developers. Send messages worldwide with just a few lines of code.
              </p>
            </div>
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>99.99% uptime SLA with end-to-end encryption for all your messages</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Send SMS to over 190 countries with local number support</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
      ...
      {/* Code Example */}
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50 mx-7">
        <div className=" px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Simple Integration</h2>
              ...
              <CardHeader>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>Lead Developer at AppWorks</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl/relaxed">
                Join thousands of developers who trust SMSimplAPI for their messaging needs
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
